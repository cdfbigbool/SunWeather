...
/**
 * Created by qiuxiuyu on 2018/7/31.
 */
public class StatusBarUtil {
    ...
    /**
     * @param activity
     * @param useThemestatusBarColor   是否要状态栏的颜色，不设置则为透明色,false透明状态栏,true#5#5#5
     * @param statusTextWhite 是否 不为暗色调
     */
